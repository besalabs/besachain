...
var PrecompiledContractsCancun = map[common.Address]PrecompiledContract{
	...
	// BesaChain ML-DSA Post-Quantum Signature Precompiles
	common.BytesToAddress([]byte{0x01, 0x20}): &mldsaVerify{},      // 0x0120
	common.BytesToAddress([]byte{0x01, 0x21}): &mldsaBatchVerify{}, // 0x0121
}
...
var PrecompiledContractsHaber = map[common.Address]PrecompiledContract{
	...
	// BesaChain ML-DSA Post-Quantum Signature Precompiles (FIPS 204)
	common.BytesToAddress([]byte{0x01, 0x20}): &mldsaVerify{},      // 0x0120
	common.BytesToAddress([]byte{0x01, 0x21}): &mldsaBatchVerify{}, // 0x0121
}
...
var PrecompiledContractsFjord = map[common.Address]PrecompiledContract{
	...
	// BesaChain ML-DSA Post-Quantum Signature Precompiles (FIPS 204)
	common.BytesToAddress([]byte{0x01, 0x20}): &mldsaVerify{},      // 0x0120 - ML-DSA-65 verify
	common.BytesToAddress([]byte{0x01, 0x21}): &mldsaBatchVerify{}, // 0x0121 - ML-DSA batch verify
}
