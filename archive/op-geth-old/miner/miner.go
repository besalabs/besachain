...
var DefaultConfig = Config{
	...
	// BesaChain L2: Modified for 250ms block time (4 blocks per second)
	// This enables high-throughput L2 operations for Chain ID 1445
	Recommit:          250 * time.Millisecond,
	NewPayloadTimeout: 250 * time.Millisecond,
